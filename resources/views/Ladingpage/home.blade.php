...
<html lang="en">
    <head>
        ...
        <link href="{{url('Ladingpage/css/bootstrap.min.css" rel="stylesheet')}}">

        <link href="{{url('Ladingpage/css/bootstrap-icons.css" rel="stylesheet')}}">

        <link href="{{url('Ladingpage/css/magnific-popup.css" rel="stylesheet')}}">

        <link href="{{url('Ladingpage/css/templatemo-first-portfolio-style.css" rel="stylesheet')}}">
...
-->
    ...
    <body>
        ...
        <!-- JAVASCRIPT FILES -->
        <script src="{{url('Ladingpage/js/jquery.min.js')}}"></script>
        <script src="{{url('Ladingpage/js/bootstrap.min.js')}}"></script>
        <script src="{{url('Ladingpage/js/jquery.sticky.js')}}"></script>
        <script src="{{url('Ladiangpage/js/click-scroll.js')}}"></script>
        <script src="{{url('Ladingpage/js/jquery.magnific-popup.min.js')}}"></script>
        <script src="{{url('Ladingpage/js/magnific-popup-options.js')}}"></script>
        <script src="{{url('Ladingpage/js/custom.js')}}"></script>
